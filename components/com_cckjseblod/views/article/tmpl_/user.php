...
<?php if ( JRequest::getVar('title') ) { ?>
<div class="componentheading"><?php echo $this->page_title; ?> - <?php echo JRequest::getVar('title'); ?></div>
<?php }else{ ?>
...
<tr>
    ...
    <?php endif; ?>
    <?php if ( $this->page_title == 'Polls' ) : ?>
    <td width="50" class="sectiontableheader" align="center">
		Result
	</td>
    <?php endif; ?>
...
<tr class="sectiontableentry<?php echo ( $i % 2 == 0 ) ? 2 : 1;?>">
    ...
    <td align="left">
    	<?php if ( $row->state && ( ! $row->category || ( $row->category && $row->cat_state ) ) ) { ?>
	        <a href="<?php echo $row->edit_link; ?>"><?php echo $row->title; ?></a>&nbsp;&nbsp;&nbsp;
            <a target="_blank" style="font-size: 8px;" href="<?php echo str_replace('home','products',$row->link); ?>">Preview</a>
        <?php } else {
        	echo $row->title;
        } ?>
    </td>
    ...
    <td width="50" class="" align="center">
		<a href="<?php echo $row->hrefpoll; ?>">View</a>
	</td>
    <?php endif; ?>
    <?php if ( $this->menu_params->get( 'show_edit' ) ) : ?>
    <td width="30" align="center">
