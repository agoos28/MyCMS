...
class ContentViewCategory extends ContentView
{
	function display($tpl = null)
	{
		...
		// Parameters
		$params->def('num_leading_articles', 	0);
		$params->def('num_intro_articles', 		12);
		$params->def('num_columns',				3);
		...
		$limit = $mainframe->getUserStateFromRequest('com_content.'.$this->getLayout().'.limit', 'limit', 12, 'int');
		$this->setLayout('blog');
