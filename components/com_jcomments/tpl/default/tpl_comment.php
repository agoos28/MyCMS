...
?>
<h5><a class="comment-anchor" href="<?php echo $thisurl; ?>#comment-<?php echo $comment->id; ?>" id="comment-<?php echo $comment->id; ?>">#<?php echo $comment_number; ?></a> <?php echo $comment->author?></h5>
<?php
				}
?>
<div class="top_row clearfix" style="padding: 10px 0 0;">
	<div class="date"><span class="fa fa-calendar"></span> <?php echo JCommentsText::formatDate($comment->date, JText::_('DATETIME_FORMAT')); ?></div>
    <a class="user" href="#" onclick="jcomments.showReply(<?php echo $comment->id; ?>); return false;">Balas</a>
</div>
