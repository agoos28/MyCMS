...
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
	<div id="comments">
	<?php if($comments){echo $comments;}else{ ?>
    	<div class="nocomments">
        	<p><strong>Suara konsumen masih kosong!</strong></p>
            <p>Silahkan buat ulasan atau tanggapan, masukan anda sangat berarti untuk kami.</p>
        </div>
    <?php } ?>
    </div>
</div>
