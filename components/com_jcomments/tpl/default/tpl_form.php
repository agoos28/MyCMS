...
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
	<div class="lbltxt"><label for="comments-form-name"><?php echo $text; ?></label><span class="req">*</span></div>
	<input id="comments-form-name" class="txtbox" type="text" name="name" value="" maxlength="<?php echo $this->getVar('comment-name-maxlength');?>" size="22" tabindex="1" style="padding: 0 15px !important;" />
</div>
<?php
		}
...
?>
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
	<div class="lbltxt"><label for="comments-form-email">Email <span class="req">*</span></div>
		<input id="comments-form-email" class="txtbox" type="text" name="email" value="" size="22" tabindex="2" style="padding: 0 15px !important;" />
</div>
...
<div style="margin-bottom: 24px;">
		<div class="lbltxt">Pesan Anda <span class="req">*</span></div>
		<textarea style="min-width: 100%; margin: 0; padding: 0 15px !important;" id="comments-form-comment" name="comment" ></textarea>
        <div style="padding: 15px 0;">
        <input class="checkbox" id="comments-form-subscribe" type="checkbox" name="subscribe" value="1" tabindex="5" />
		<label for="comments-form-subscribe">Email saya apabila ada komentar baru.</label>
        </div>
...
<div style="overflow: hidden;">
    ...
    <div style="margin-left: 140px;">
		<span class="captcha" onclick="jcomments.clear('captcha');">Ganti Captcha</span><br />
...
<a class="btn" href="#" tabindex="7" onclick="jcomments.saveComment();return false;" title="<?php echo JText::_('FORM_SEND_HINT'); ?>"><?php echo JText::_('FORM_SEND'); ?></a>
	<a class="clear_btn" href="#" tabindex="8" onclick="return false;" title="<?php echo JText::_('FORM_CANCEL'); ?>"><?php echo JText::_('FORM_CANCEL'); ?></a>
