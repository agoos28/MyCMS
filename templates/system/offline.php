...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>" style="height: 100%;">
<head>
...
<body style="left: 0px; right: 0px; background-image: url('<?php echo $this->baseurl ?>images/um.jpg'); position: absolute; bottom: 0px; top: 0px; background-repeat: no-repeat; background-size: cover; background-position: 0% 50%;">

	<form action="index.php" method="post" name="login" id="form-login" style="display: none !important;">
