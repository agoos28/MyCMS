...
<form action="index.php" id="imageForm" method="post" enctype="multipart/form-data">
	...
	<fieldset>
		...
		<div style="float: right">
			<button class="insert" rel="<?php echo JRequest::getVar('e_name'); ?>" type="button" ><?php echo JText::_('Insert') ?></button>
			<button type="button" class="close"><?php echo JText::_('Cancel') ?></button>
		</div>
	</fieldset>
