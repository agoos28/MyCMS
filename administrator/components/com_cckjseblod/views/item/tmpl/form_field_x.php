...
$styleopt[] 	=	JHTML::_( 'select.option', 1, 'list');
$styleopt[] 	=	JHTML::_( 'select.option', 2, 'grid');
$currentstyle	= 	( @$this->item->style ) ? $this->item->style : 1;
$stylesel	 	=	JHTML::_( 'select.genericlist', $styleopt, 'style', 'size="1" class="inputbox"', 'value', 'text', $currentstyle );
?>
...
<legend class="legend-border">
    ...
    <table class="admintable">
    	<tr>
			...
			<td width="100" align="right" class="key">
				<span class="editlinktip hasTip2" title="<?php echo JText::_( 'STYLES' ); ?>::<?php echo JText::_( 'EDIT STYLES' ); ?>">
					<?php echo JText::_( 'STYLES' ); ?>:
				</span>
			</td>
			<td>
				<?php echo $stylesel; ?>
