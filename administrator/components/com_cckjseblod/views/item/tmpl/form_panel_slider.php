...
<legend class="legend-border">
	...
	<table class="admintable">
        ...
        <tr>
			<td width="25" align="right" class="key_jseblod">
				<span class="editlinktip hasTip2" title="<?php echo JText::_( 'Container Class' ); ?>::<?php echo JText::_( 'Container Class' ); ?>">
					<?php echo _IMG_BALLOON_LEFT; ?>
				</span>
			</td>
			<td width="100" align="right" class="key">
				<span class="editlinktip hasTip2" title="<?php echo JText::_( 'Container Class' ); ?>::<?php echo JText::_( 'Container Class' ); ?>">
					<?php echo JText::_( 'Container Class' ); ?>:
				</span>
			</td>
			<td>
				<input class="inputbox" type="text" id="style" name="style" maxlength="50" size="32" value="<?php echo @$this->item->style; ?>" />
			</td>
		</tr>
        <?php } ?>
        <tr>
