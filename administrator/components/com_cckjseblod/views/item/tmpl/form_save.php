...
$optInCategories[] 		=	JHTML::_( 'select.option', 3, JText::_( 'SECTION' ) );
...
$optJoomlaSections		=	HelperjSeblod_Helper::getJoomlaSections();
$selectJoomlaSections		=	explode( ',', @$this->item->options );
$lists['joomlaSections']	=	JHTML::_( 'select.genericlist', $optJoomlaSections, 'bool3', 'class="inputbox" size="15" multiple="multiple" style="width: 147px;"', 'value', 'text', $selectJoomlaSections );
...
<legend class="legend-border">
    ...
    <tr id="as-free-sections" class="<?php echo ( @$this->item->bool2 == 1 ) ? '' : '' ?>">
			<td width="25" align="right" class="key_jseblod">
			</td>
			<td width="100" align="right" class="key">
				<span class="editlinktip hasTip2" title="<?php echo JText::_( 'SECTIONS' ); ?>::<?php echo JText::_( 'SELECT SECTIONS' ); ?>">
					<?php echo JText::_( 'SECTIONS' ); ?>:
				</span>
			</td>
			<td>
				<?php echo $lists['joomlaSections']; ?>
			</td>
		</tr>
		<tr>
            <td width="25" align="right" class="key_jseblod">
