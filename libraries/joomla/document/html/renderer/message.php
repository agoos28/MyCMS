			...
			if (is_array($lists))
		{
			...
			foreach ($lists as $type => $msgs)
			{
				...
				foreach ($msgs as $msg)
				{
					...
					$contents .= '<div class="alert alert-block '.$class.' fade in"><button data-dismiss="alert" class="close" type="button">×</button><h4 class="alert-heading"><i class="'.$icon.'"></i> '.$title.'</h4>'.$message.'</div>';
